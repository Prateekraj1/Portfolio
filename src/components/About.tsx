      ...
      <section className='max-w-5xl mx-auto sm:p-16 pb-12 !pt-[126px] px-8 min-h-[calc(100vh-80px)]'>
        ...
        <div className='py-10 flex flex-col'>
          ...
          <div className='mt-16 flex flex-wrap gap-12'>
            {skills.map((skill) => (
              <div className='relative transition-[250ms] [perspective:500px] w-20 h-20' key={skill.name}>
        ...
        <div className='py-10 flex flex-col'>
          <h3 className='font-semibold sm:text-3xl text-xl relative font-poppins'>My Resume</h3>
